...
import com.isoft.dls.sync.config.audit.AuditEventConverter;
import com.isoft.dls.sync.domain.PersistentAuditEvent;
...
import static com.isoft.dls.sync.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
