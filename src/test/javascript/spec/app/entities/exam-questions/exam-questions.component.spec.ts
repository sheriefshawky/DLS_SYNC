...
import { ExamQuestionsComponent } from 'app/entities/exam-questions/exam-questions.component';
...
describe('Component Tests', () => {
  describe('ExamQuestions Management Component', () => {
    let comp: ExamQuestionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExamQuestionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.examQuestions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
