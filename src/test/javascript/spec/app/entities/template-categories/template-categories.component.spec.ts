...
import { TemplateCategoriesComponent } from 'app/entities/template-categories/template-categories.component';
...
describe('Component Tests', () => {
  describe('TemplateCategories Management Component', () => {
    let comp: TemplateCategoriesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TemplateCategoriesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new TemplateCategories(123)],
            headers
          })
        )
      );
      ...
      expect(comp.templateCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
